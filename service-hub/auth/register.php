...
.logo-icon { width:5rem; height:5rem; object-fit:cover; border-radius:8px; display:block; flex-shrink:0; box-shadow:0 0 12px rgba(34,211,238,0.45); -webkit-background-clip:unset !important; background-clip:unset !important; -webkit-text-fill-color:unset !important; }
