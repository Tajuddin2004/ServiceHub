...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($error)) {
        ...
        if ($check->num_rows > 0) {
            ...
            if ($role === 'provider') {
                // Insert user as provider (inactive until approved)
                $stmt = $conn->prepare(
                ...
                if ($stmt->execute()) {
                    ...
                    $success = "Your application has been submitted and is under admin review.";
                } else {
                    $error = "Something went wrong. Please try again.";
                }
            } else {
                // Insert user as consumer (active immediately)
                $stmt = $conn->prepare(
                    "INSERT INTO users (name, email, password, role, status)
                     VALUES (?, ?, ?, 'consumer', 1)"
                );
...
<head>
<meta charset="UTF-8">
<title>Tazx Happy-Home | Sign Up</title>
...
.role-toggle.provider-active::before {
...
#providerFields .form-group {
    transform: translateY(-10px);
    opacity: 0;
    transition: transform 0.4s ease, opacity 0.4s ease;
}

#providerFields.show .form-group {
    transform: translateY(0);
    opacity: 1;
}

#providerFields.show .form-group:nth-child(1) { transition-delay: 0.1s; }
#providerFields.show .form-group:nth-child(2) { transition-delay: 0.15s; }
#providerFields.show .form-group:nth-child(3) { transition-delay: 0.2s; }
#providerFields.show .form-group:nth-child(4) { transition-delay: 0.25s; }
#providerFields.show .form-group:nth-child(5) { transition-delay: 0.3s; }
    ...
    <div class="register-card">
        <div class="register-header">
            <div class="logo">
                ...
                <span class="logo-text">Tazx Happy-Home</span>
            </div>
        ...
        <form method="POST" id="registerForm">
            ...
            <div class="form-group">
                ...
                <div class="password-wrapper">
                    <input type="password" name="password" class="form-input" id="password" placeholder="At least 6 characters" required minlength="6">
            ...
            <div id="providerFields">
                ...
                <div class="form-group">
                    ...
                    <textarea name="about_work" id="about_work" class="form-input" rows="3" placeholder="Briefly describe your skills and work experience"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pincode" id="pincode" class="form-input" maxlength="6" placeholder="e.g. 560001" pattern="[0-9]{6}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="phone-flex">
                        ...
                        <input type="text" name="phone" id="phone" class="form-input" placeholder="9876543210" maxlength="10" pattern="[0-9]{10}">
                    </div>
                </div>
            </div>
...
buttons.forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        // Slide the background indicator
        if (role === 'provider') {
            roleToggle.classList.add('provider-active');
            
            // Show provider fields with smooth animation
            ...
            // Hide provider fields with smooth animation
